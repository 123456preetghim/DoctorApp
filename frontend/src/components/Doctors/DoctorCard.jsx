...
const DoctorCard = ({doctor}) => {
  ...
  return (
    <div className='p-3 lg:p-5'>
        ...
        <h2 className='text-[18px] leading-[30px] last:text-[26px] lg:leading-9 text-headingColor 
        ...
        <div className='mt-2 lg:mt-4 flex items-center justify-between'>
            ...
            <div className='flex items-center gap-[6px]'>
                <span className='flex items-center gp-[6px] text-[14px] leading-6 lg:text-[16px] lg:leading-7
        ...
        <div className='mt-[18px] lg:mt-5 flex items-center justify-between'>
            <div>
                <h3 className='text-[16px] leading-7 lg:text-[10px] lg:leading-[30px] font-semibold 
